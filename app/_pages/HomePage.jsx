...
export const HomePage = () => {
  return (
    <>
      ...
      <section id="reviews" className="bg-[#f0e8fc] px-32 py-20 flex flex-col items-center">
      ...
      <section id="newfeats" className="bg-[#f0e8fc] flex flex-col items-center justify-center gap-10 px-32 py-20">
