...
export const Navbar = () => {
  return (
    <>
      <nav className="flex justify-center w-screen my-8">
        <div className="flex items-center justify-center gap-28 bg-[#f0edf5] rounded-full px-20 py-8 shadow-[0px_3px_15px_rgba(0,0,0,0.1)]">
